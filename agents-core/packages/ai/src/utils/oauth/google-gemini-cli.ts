...
function ensureGeminiCliOAuthConfig(): void {
	if (CLIENT_ID && CLIENT_SECRET) {
		return;
	}
	throw new Error(
		"Google Gemini CLI OAuth is disabled in this repository snapshot. " +
			"Set GOOGLE_GEMINI_CLI_CLIENT_ID and GOOGLE_GEMINI_CLI_CLIENT_SECRET to enable it locally.",
	);
}
