...
function ensureAntigravityOAuthConfig(): void {
	if (CLIENT_ID && CLIENT_SECRET) {
		return;
	}
	throw new Error(
		"Google Antigravity OAuth is disabled in this repository snapshot. " +
			"Set GOOGLE_ANTIGRAVITY_CLIENT_ID and GOOGLE_ANTIGRAVITY_CLIENT_SECRET to enable it locally.",
	);
}
